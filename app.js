...
function colorizeSliders(color, hue, brightness, saturation) {
  ...
  brightness.style.backgroundImage = `linear-gradient(to right, ${scaleBright(0)}, ${scaleBright(0.5)}, ${scaleBright(
    1,
  )})`;
...
function hslControls(e) {
  const index =
    e.target.getAttribute("data-bright") || e.target.getAttribute("data-sat") || e.target.getAttribute("data-hue");
...
const saveCred = document.querySelector(".save-credentials");
...
saveCred.addEventListener("click", closeLogin);
